                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _manualSection(
                        '메인 화면',
                        '금연 시작일, 누적일, 목표일, 실시간 금연 시간, 총 절약 금액, 환전 가능 금액, 참은 담배 개수, 실패 횟수, 금연코인을 한눈에 볼 수 있습니다. 상단 가운데는 「금연 현황」이며, 왼쪽의 「금연코인」이나 환전 가능 금액을 누르면 환전 화면으로 이동해 절약 금액을 코인으로 바꿀 수 있습니다(100원당 1코인). 목표일·실패 횟수는 노란색 밑줄로 표시되며, 실패 횟수를 누르면 금연코인 5개로 1회 차감할 수 있습니다(코인 부족 시 불가). 금연 이유, 마음 다잡기, 흔들림 기록, 금연 리셋, 알림(설정에서 관리) 등은 메인에서 바로 이용할 수 있고, 하단 탭으로는 「메인」「게임」「성장시키기」「건강/커뮤니티」「수집·도감」이 있습니다.',
                      ),
                      _manualSection(
                        '금연코인',
                      ...
                      _manualSection(
                        '건강 / 커뮤니티',
                        '하단 「건강/커뮤니티」 탭에서 다음을 선택할 수 있습니다. 「나의 폐 건강」에서는 금연 기간에 따라 폐 회복 상태를 퍼센트로 확인할 수 있으며, 흔들림을 기록하면 건강도가 일정 비율 감소하고 금연을 유지하면 시간이 지나며 서서히 회복됩니다. 「건강 개선 현황」에서는 금연 경과 시간에 따른 대표적인 건강 개선 단계(20분, 8시간, 24시간, 48시간, 72시간, 2주~3개월, 1~9개월, 1년 등)와 몸의 변화 설명을 볼 수 있습니다. 「담타시간(커뮤니티)」에서는 담타 루틴을 체험하며 다시 복귀를 준비할 수 있습니다.',
                      ),
                      _manualSection(
                        '게임',
