...
class HelpScreen extends StatelessWidget {
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _manualSection(
                        '금연코인',
                        '출석체크를 하면 매일 금연코인을 받을 수 있습니다(1~6일차 15코인, 7·14·21·28일차 20코인). 금연코인은 담배 수집 시 1회 시도할 때마다 2코인이 소모되며, 메인 화면에서 실패 횟수를 1회 줄일 때 5코인이 소모됩니다. 코인이 부족하면 해당 기능을 사용할 수 없습니다.',
                      ),
                      _manualSection(
                        '알림',
                      ...
                      _manualSection(
                        '게임',
                        '1부터 30까지 순서대로 숫자를 빠르게 누르는 숫자 게임, 섞인 글자를 연결해 찾는 단어맞추기, 움직이는 표시가 중앙에 올 때 탭하는 완벽 타이밍 게임을 즐길 수 있습니다. 간단한 조작으로 집중력을 높이고 금연 스트레스를 해소해 보세요.',
                      ),
                      _manualSection(
                        '위젯',
  ...
  static final List<({String question, String answer})> _faqItems = [
    ...
    (
      ...
      answer:
          '출석체크를 하면 매일 금연코인을 받습니다(1~6일차 15코인, 7·14·21·28일차 20코인). 금연코인은 담배 수집 시 1회 시도할 때마다 2코인, 메인 화면에서 실패 횟수를 1회 줄일 때 5코인이 소모됩니다. 코인이 부족하면 해당 기능을 사용할 수 없습니다.'
    ),
    (
    ...
    (
      ...
      answer:
          '게임(숫자 게임, 단어맞추기, 완벽 타이밍, 담배맞추기)은 금연 스트레스를 줄이고 집중을 돌리는 역할을 합니다. 점수와 레벨은 기기 안에만 저장되며, 금연 시간·절약 금액에는 직접적인 영향을 주지 않습니다.'
    ),
    (
