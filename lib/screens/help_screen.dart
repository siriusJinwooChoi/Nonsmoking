...
class HelpScreen extends StatelessWidget {
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _manualSection(
                        '금연코인',
                        '출석체크를 하면 매일 금연코인을 받을 수 있습니다(1~6일차 10코인, 7·14·21·28일차 20코인). 금연코인은 담배 수집 시 1회 시도할 때마다 2코인이 소모되며, 메인 화면에서 실패 횟수를 1회 줄일 때 5코인이 소모됩니다. 코인이 부족하면 해당 기능을 사용할 수 없습니다.',
                      ),
                      _manualSection(
                        '알림',
  ...
  static final List<({String question, String answer})> _faqItems = [
    ...
    (
      ...
      answer:
          '출석체크를 하면 매일 금연코인을 받습니다(1~6일차 10코인, 7·14·21·28일차 20코인). 금연코인은 담배 수집 시 1회 시도할 때마다 2코인, 메인 화면에서 실패 횟수를 1회 줄일 때 5코인이 소모됩니다. 코인이 부족하면 해당 기능을 사용할 수 없습니다.'
    ),
    (
